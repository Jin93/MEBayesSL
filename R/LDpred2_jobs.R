...
for (chr in chrs){
  if (chr < 7) system(paste0('qsub -cwd -l mem_free=23G,h_vmem=23G,h_fsize=100g ' ,rscripts_path, 'LDpred2_rscript_chr', chr, ".sh"))
  if ((chr >= 7)&(chr < 14)) system(paste0('qsub -cwd -l mem_free=16G,h_vmem=16G,h_fsize=100g ' ,rscripts_path, 'LDpred2_rscript_chr', chr, ".sh"))
  if ((chr >= 14)&(chr < 19)) system(paste0('qsub -cwd -l mem_free=12G,h_vmem=12G,h_fsize=100g ' ,rscripts_path, 'LDpred2_rscript_chr', chr, ".sh"))
  if ((chr >= 19)&(chr <= 22)) system(paste0('qsub -cwd -l mem_free=7G,h_vmem=7G,h_fsize=100g ' ,rscripts_path, 'LDpred2_rscript_chr', chr, ".sh"))
}
